...
import { KEY_TYPES, CERT_TYPES } from './constants.js';
...
export const isDomainMatch = curry((toCheck, base) => {
...
export const isCertValidFormat = anyPass(buildValidFormatFunc(CERTIFICATE_PAIRS));

export const isKeyValidFormat = anyPass(buildValidFormatFunc(KEY_PAIRS));

export const trimLower = pipe(trim, toLower);

export const isValidDate = (info, skipDateValidation = false) => {
